...
// Zero constant for length comparison
const ZERO = 0;
    ...
    >
      <div className="bg-white/20 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-2xl w-full">
        ...
        <div className="flex flex-col gap-3">
          {state.proverbs?.map((proverb, idx) => (
            <div
              key={proverb}
            ...
            >
              ...
              <button
                onClick={() =>
                  setState({
                    ...state,
                    proverbs: state.proverbs?.filter((_, i) => i !== idx),
                  })
                }
...
// Sets via tool calls.
const WeatherCard = ({ location, themeColor }: { location?: string; themeColor: string }) => (
  <div
    style={{ backgroundColor: themeColor }}
